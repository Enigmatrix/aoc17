pub const DAY1:&'static str = "";
pub const DAY2:&'static str = "737	1866	1565	1452	1908	1874	232	1928	201	241	922	281	1651	1740	1012	1001
...
pub const DAY3:&'static str = "368078";
pub const DAY4:&'static str = "sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
...
pub const DAY7:&'static str = "jlbcwrl (93)
...
hpuyku (82)";
pub const DAY8:&'static str = "av inc 167 if f > -9
av inc 640 if uea == 0
fk dec -960 if tn > -9
...
1998 <-> 1522, 1577, 1790
1999 <-> 308, 799, 1013";
pub const DAY13:&'static str = "0: 3
1: 2
2: 5
4: 4
6: 6
...
pub const DAY19:&'static str = " |                                                                                                                                                                                                       
 ...
 +-------------+ +-----------------------------------------+                           +-+ +---+ +-----------------+       +-------------------------------------------------+           +---------+     
                                                                                                                                                                                                         ";
pub const DAY20:&'static str = "p=<1609,-863,-779>, v=<-15,54,-69>, a=<-10,0,14>
...
####.########.#.#..##.#.#
#####.#..##...####.#..#..";
pub const DAY23:&'static str = "set b 65
set c b
jnz a 2
jnz 1 5
mul b 100
...
sub b -17
jnz 1 -23";
pub const DAY24:&'static str = "14/42
2/3
6/44
4/10
23/49
...
2/13
48/14";
pub const DAY25:&'static str = "Begin in state A.
